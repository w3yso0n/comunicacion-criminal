import { FuentesTable } from "@/components/dashboard/fuentes-table";
    ...
    <div className="mx-auto max-w-[1200px] space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-xs text-zinc-500">
          Cuentas y canales con ranking por actividad, engagement y riesgo discursivo.
          Expande una fila para ver el histórico de publicaciones (mock).
        </p>
      </header>

      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        {[
          { label: "Total fuentes", value: total },
          { label: "Fuentes críticas", value: criticos },
          { label: "Nuevas esta semana", value: nuevos },
